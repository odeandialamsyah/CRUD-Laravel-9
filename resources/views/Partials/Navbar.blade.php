{{-- Navbar  --}}
<header>
    <nav class="fixed top-0 z-10 items-center w-full py-4 bg-black">
        <div class="flex items-center justify-between">
            ...
            <div class="space-x-5 pr-20 flex">
                <a href="{{ url('/') }}"
                    class="text-white font-semibold hover:text-blue-600 transition duration-300">Home</a>
                <a href="{{url('about')}}"
                    class="text-white font-semibold hover:text-blue-600 transition duration-300">About</a>
                <a href="{{url('contact')}}"
                    class="text-white font-semibold hover:text-blue-600 transition duration-300 mr-10">Contact</a>
                        ...
                        <div id="gambar"
                            ...
                            <div class="py-1" role="none">
                                <a href="{{ route('login') }}" class="text-gray-700 block px-4 py-2 text-sm"
                                    role="menuitem" tabindex="-1" id="menu-item-1">Login</a>
                                <a href="{{ route('register') }}" class="text-gray-700 block px-4 py-2 text-sm"
                                    role="menuitem" tabindex="-1" id="menu-item-2">Register</a>
                            </div>
                        </div>
                    </div>
                @endauth
